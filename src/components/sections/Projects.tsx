          ...
          {projects.map((project, index) => (
            ...
            >
              <motion.div
                ...
                className="group relative bg-white dark:bg-gray-800 rounded-2xl shadow-2xl overflow-hidden border border-gray-200 dark:border-gray-700 hover:shadow-primary-500/30 transition-all duration-500 h-[480px] flex flex-col" // <-- add fixed height and flex
              >
